...
Menu "Macros"
	"Load Raman Data", LoadRamanData()
End

Function LoadRamanData()
	...
	string ListOfFiles = IndexedFile(PathName, -1, "TEXT")	// Get list of all text files in folder
	string CurrentFile = ""	
	variable i
	...
	do 
		...
		string CurrentFile2 = CurrentFile[0, strlen(CurrentFile)]
		...
		LoadWave/J/D/O/B="C=1,N='Wave Number (nm)'; C=1, N='_skip_'; C=1,N='Intensity';"/A=Column/K=0/L={0,1,0,0,0} /P=PathName CurrentFile 
