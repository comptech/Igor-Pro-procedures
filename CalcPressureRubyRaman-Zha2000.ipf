...
// Version 0.1, 6/4/2011

#pragma rtGlobals=1		// Use modern global access method.
Menu "Macros"
	"Calculate Ruby Pressure - Zha2000", DisplayPressureCalcControlP()
End
...
Window PressureCalcControlPanel2() : Panel
	...
	DrawText 226,249,"(ref: Zha et al., 2000, PNAS)"
	...
	SetVariable XSetVar,limits={694,800,0.1},value= root:Packages:PressureCalcControlPanel2:gRubyCurrent
	Button ComputeButton,pos={105,129},size={178,23},proc=ComputePressureProc2,title="Compute Ruby Pressure"
	...
	ValDisplay dispressure,value= #"root:Packages:PressureCalcControlPanel2:gPressure"
	...
	ValDisplay dispressureerrG,value= #"root:Packages:PressureCalcControlPanel2:gPressureErrG"
	...
	SetVariable ZeroPR1,limits={694,800,0},value= root:Packages:PressureCalcControlPanel2:gRubyStd
	...
	SetVariable XSetVar1,limits={0,2,0.1},value= root:Packages:PressureCalcControlPanel2:gRubyFWHM
	...
	ValDisplay dispressureerrL,value= #"root:Packages:PressureCalcControlPanel2:gPressureErrL"
EndMacro

// This is the action procedure for the Compute button.
// We created it using the Button dialog.
Function ComputePressureProc2(ctrlName) : ButtonControl
	String ctrlName

	String dfSave = GetDataFolder(1)
	SetDataFolder root:Packages:PressureCalcControlPanel2

	NVAR gRubyCurrent, gRubyFWHM, gRubyStd, gPressure, gPressureErrG, gPressureErrL			// Access current data folder.
	
	gPressure = 19.04/7.665*((1+((gRubyCurrent-gRubyStd)/gRubyStd))^7.715-1)*100
	gPressureErrG = 1904*gRubyFWHM/2.35482*(gRubyCurrent/gRubyStd)^7.715/gRubyCurrent
	gPressureErrL = 1904*gRubyFWHM/2.00*(gRubyCurrent/gRubyStd)^7.715/gRubyCurrent
...
Function DisplayPressureCalcControlP()
	...
	NewDataFolder/O/S root:Packages:PressureCalcControlPanel2
	...
	Execute "PressureCalcControlPanel2()"
